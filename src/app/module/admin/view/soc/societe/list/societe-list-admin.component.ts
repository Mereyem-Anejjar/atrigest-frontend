...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'type?.code', header: 'Type'},
            {field: 'dateCreation', header: 'Date creation'},
            {field: 'rc', header: 'Rc'},
            {field: 'taxeProfessionnelle', header: 'Taxe professionnelle'},
            {field: 'ice', header: 'Ice'},
            {field: 'gerant', header: 'Gerant'},
        ];
    }


    public async loadType(){
        this.typeSocieteService.findAllOptimized().subscribe(types => this.types = types, error => console.log(error))
    }


	public initDuplicate(res: SocieteDto) {
        if (res.associes != null) {
             res.associes.forEach(d => { d.societe = null; d.id = null; });
        }
	}
   ...
   public prepareColumnExport(): void {
        ...
        //'Type': this.criteria.type?.code ? this.criteria.type?.code : environment.emptyForExport ,
            ...
            'Gerant': this.criteria.gerant ? this.criteria.gerant : environment.emptyForExport ,
        }];
      }

...
@Component({
  selector: 'app-associe-list-admin',
  templateUrl: './associe-list-admin.component.html'
})
export class AssocieListAdminComponent implements OnInit {

    protected fileName = 'Associe';
    ...
    roleAssocies: Array<RoleAssocieDto>;
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<AssocieDto>();
    ...
    public async edit(dto: AssocieDto) {
    ...
    public async view(dto: AssocieDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: AssocieDto) {
    ...
    public async duplicate(dto: AssocieDto) {
    ...
    public exportPdf(dto: AssocieDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'societe?.nom', header: 'Societe'},
            {field: 'roleAssocie?.code', header: 'Role associe'},
        ];
    }
    ...
    public async loadRoleAssocie(){
        this.roleAssocieService.findAllOptimized().subscribe(roleAssocies => this.roleAssocies = roleAssocies, error => console.log(error))
    }


	public initDuplicate(res: AssocieDto) {
	}
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                 'Nom': e.nom ,
                'Societe': e.societe?.nom ,
                'Role associe': e.roleAssocie?.code ,
            }
        });

        this.criteriaData = [{
            'Nom': this.criteria.nom ? this.criteria.nom : environment.emptyForExport ,
        //'Societe': this.criteria.societe?.nom ? this.criteria.societe?.nom : environment.emptyForExport ,
        //'Role associe': this.criteria.roleAssocie?.code ? this.criteria.roleAssocie?.code : environment.emptyForExport ,
        }];
      }
    ...
    get selections(): Array<AssocieDto> {
        return this.service.selections;
    }

    set selections(value: Array<AssocieDto>) {

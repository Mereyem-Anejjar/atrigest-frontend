...
import {BanqueCriteria} from 'src/app/shared/criteria/commun/BanqueCriteria.model';
...
export class BanqueListAdminComponent implements OnInit {
    ...
    public async edit(dto: BanqueDto) {
    ...
    public async view(dto: BanqueDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: BanqueDto) {

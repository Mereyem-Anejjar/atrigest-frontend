...
export class NotificationListAdminComponent implements OnInit {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<NotificationDto>();
    ...
    public async edit(dto: NotificationDto) {
    ...
    public async view(dto: NotificationDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: NotificationDto) {
    ...
    public async duplicate(dto: NotificationDto) {
    ...
    public exportPdf(dto: NotificationDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            {field: 'contenue', header: 'Contenue'},
	...
	public initDuplicate(res: NotificationDto) {
        if (res.notificationDetails != null) {
             res.notificationDetails.forEach(d => { d.notification = null; d.id = null; });
        }
	}
   ...
   public prepareColumnExport(): void {
        ...
        this.criteriaData = [{
            'Contenue': this.criteria.contenue ? this.criteria.contenue : environment.emptyForExport ,
    ...
    get selections(): Array<NotificationDto> {
        return this.service.selections;
    }

    set selections(value: Array<NotificationDto>) {

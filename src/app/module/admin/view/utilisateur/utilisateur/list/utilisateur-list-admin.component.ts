...
import {UtilisateurCriteria} from 'src/app/shared/criteria/utilisateur/UtilisateurCriteria.model';
...
export class UtilisateurListAdminComponent implements OnInit {
    ...
    constructor( private service: UtilisateurAdminService  , @Inject(PLATFORM_ID) private platformId?) {

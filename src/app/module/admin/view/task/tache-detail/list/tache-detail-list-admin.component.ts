...
@Component({
  selector: 'app-tache-detail-list-admin',
  templateUrl: './tache-detail-list-admin.component.html'
})
export class TacheDetailListAdminComponent implements OnInit {

    protected fileName = 'TacheDetail';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<TacheDetailDto>();
    ...
    public async edit(dto: TacheDetailDto) {
    ...
    public async view(dto: TacheDetailDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: TacheDetailDto) {
    ...
    public async duplicate(dto: TacheDetailDto) {
    ...
    public exportPdf(dto: TacheDetailDto): void {
...
// add
    ...
    public async loadTache(){
        this.tacheService.findAll().subscribe(taches => this.taches = taches, error => console.log(error))
    }


	public initDuplicate(res: TacheDetailDto) {
	}
   ...
   public prepareColumnExport(): void {
        ...
        //'Tache': this.criteria.tache?.id ? this.criteria.tache?.id : environment.emptyForExport ,
        }];
      }
    ...
    get selections(): Array<TacheDetailDto> {
        return this.service.selections;
    }

    set selections(value: Array<TacheDetailDto>) {

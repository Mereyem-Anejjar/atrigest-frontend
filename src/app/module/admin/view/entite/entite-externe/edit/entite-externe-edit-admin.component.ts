...
@Component({
  selector: 'app-entite-externe-edit-admin',
  templateUrl: './entite-externe-edit-admin.component.html'
})
export class EntiteExterneEditAdminComponent implements OnInit {
 ...
 public edit(): void {
   ...
   public async openCreateTypeEntiteExterne(typeEntiteExterne: string) {
        const isPermistted = await this.roleService.isPermitted('TypeEntiteExterne', 'edit');
        if (isPermistted) {

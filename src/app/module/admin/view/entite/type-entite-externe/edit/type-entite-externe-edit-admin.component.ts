...
@Component({
  selector: 'app-type-entite-externe-edit-admin',
  templateUrl: './type-entite-externe-edit-admin.component.html'
})
export class TypeEntiteExterneEditAdminComponent implements OnInit {

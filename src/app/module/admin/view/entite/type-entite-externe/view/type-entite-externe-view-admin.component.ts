...
@Component({
  selector: 'app-type-entite-externe-view-admin',
  templateUrl: './type-entite-externe-view-admin.component.html'
})
export class TypeEntiteExterneViewAdminComponent implements OnInit {
    ...
    constructor(private service: TypeEntiteExterneAdminService){

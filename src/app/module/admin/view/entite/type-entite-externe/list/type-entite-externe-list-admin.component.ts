...
@Component({
  selector: 'app-type-entite-externe-list-admin',
  templateUrl: './type-entite-externe-list-admin.component.html'
})
export class TypeEntiteExterneListAdminComponent implements OnInit {

    protected fileName = 'TypeEntiteExterne';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<TypeEntiteExterneDto>();
    ...
    public async edit(dto: TypeEntiteExterneDto) {
    ...
    public async view(dto: TypeEntiteExterneDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: TypeEntiteExterneDto) {
    ...
    public async duplicate(dto: TypeEntiteExterneDto) {
    ...
    public exportPdf(dto: TypeEntiteExterneDto): void {
...
// add
	...
	public initDuplicate(res: TypeEntiteExterneDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<TypeEntiteExterneDto> {
        return this.service.selections;
    }

    set selections(value: Array<TypeEntiteExterneDto>) {
